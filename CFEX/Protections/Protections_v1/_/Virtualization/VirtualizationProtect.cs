...
namespace Eddy_Protector.Protections.Virtualization
{
 class VirtualizationProtect : ProtectionPhase
 {
  ...
  public void Initialize(Context ctx)
  {
   ...
   string rtName = "_"+ctx.generator.RandomUlong().ToString();
   ModuleDefMD RuntimeModule = ModuleDefMD.Load("Eddy^VirtualRT.dll");
