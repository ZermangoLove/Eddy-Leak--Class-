...
{
 public sealed class InstructionsParser : IEnumerable<ILInstruction>, IEnumerable
 {
  ...
  public InstructionsParser(MethodBase method)
  {
  ...
  ILInstruction Next()
  {
   ...
   switch (opCode.OperandType)
   {
    case OperandType.InlineNone:
     return new UnhandledInstruction(offset, opCode);
