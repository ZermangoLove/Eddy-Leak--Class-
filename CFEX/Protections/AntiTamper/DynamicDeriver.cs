...
namespace Protector.Protections.AntiTamper
{
	internal class DynamicDeriver : IKeyDeriver
	{
		...
		public void Init(ProtectorContext ctx, RandomGenerator random)
		{
		...
		public IEnumerable<Instruction> EmitDerivation(MethodDef method, ProtectorContext ctx, Local dst, Local src)
		{
