...
namespace Protector.Protections.AntiTamper
{
	internal class JITMode : IModeHandler
	{
		...
		public ModuleDef HandleInject(ModuleDef module,ProtectorContext context)
		{
   ...
   z = random.NextUInt32();
			...
			TypeDef initType = DnLibHelper.GetRuntimeType("Protector.Runtime.AntiTamperJIT");
			...
			cctorRepl = new MethodDefUser(context.random_generator.GenerateString(), MethodSig.CreateStatic(module.CorLibTypes.Void));
   ...
   return module;
		...
		public void HandleMD(List<MethodDef> methods_input,ProtectorContext context)
		{
		...
		void CreateSection(List<MethodDef> methods, ModuleWriterBase writer)
		{
